...
public class MainActivity extends SherlockFragmentActivity implements Product.OnSaveProduct,
			OnLoadData {
	...
	private void hideActionBarIcons() {
		...
		mActionMenu.findItem(R.id.action_refresh).setVisible(false);
	}
	...
	private boolean isNetworkAdapterConnected() {
		boolean result = false;
		ConnectivityManager connManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
		NetworkInfo info = connManager.getActiveNetworkInfo();
		if ((info!=null) && (info.isConnected())) result = true; 
		return result;
	}
	...
	private void showActionBarIcons() {
		...
		mActionMenu.findItem(R.id.action_refresh).setVisible(true);
	}
