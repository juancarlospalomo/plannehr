...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int mTabViewSlidingResId = -1;
    private int mTabViewTextAppearanceResId = -1;
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.slidingTabLayoutStyle);
    }
    ...
    /**
     * Get the Theme or View attributes and set the values into module vars
     *
     * @param context  Activity context
     * @param attrs    attr set
     * @param defStyle default attr style
     */
    private void setAttributes(Context context, AttributeSet attrs, int defStyle) {
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.slidingTabLayout, defStyle, 0);
        try {
            mTabViewSlidingResId = typedArray.getResourceId(R.styleable.slidingTabLayout_slidingTabView, -1);
            if (mTabViewSlidingResId != -1) {
                typedArray = context.getTheme().obtainStyledAttributes(mTabViewSlidingResId, R.styleable.slidingTabView);
                mTabViewTextAppearanceResId = typedArray.getResourceId(R.styleable.slidingTabView_android_textAppearance,
                        mTabViewTextAppearanceResId);
                mTabViewPaddingLeft = (int) typedArray.getDimension(R.styleable.slidingTabView_android_paddingLeft, 0);
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        if (mTabViewTextAppearanceResId != -1) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                textView = new TextView(getContext(), mAttrs, R.attr.slidingTabViewTextAppearance);
            } else {
                textView = new TextView(getContext(), mAttrs, 0, mTabViewTextAppearanceResId);
            }
        } else {
            textView = new TextView(getContext(), mAttrs, R.attr.slidingTabViewTextAppearance);
        }
    ...
    private void populateTabStrip() {
        ...
        this.setBackgroundColor(mTabViewBackgroundColor);
